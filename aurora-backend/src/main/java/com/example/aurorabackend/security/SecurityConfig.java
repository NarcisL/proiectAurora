...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authz -> authz
                        ...
                        .requestMatchers("/api/auth/**").permitAll()             // Permit all under /api/auth/
                        .requestMatchers(HttpMethod.POST, "/api/users/register").permitAll() // Registration
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedHeaders(Arrays.asList(
                ...
                "Access-Control-Request-Headers" // Ensure this is present for preflight
        ));
